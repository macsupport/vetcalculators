...
cordova.plugins.printer.print( htmlStart  + htmlEnd, 'Document.html', function () {
...
$(document).on('click touchstart','.printmex',function() {
  //var printLink = $(this).attr('data-printme');
     //var gridElement = $('#'+ printLink),
     var gridElement = $('#anestheticPage'),
            printableContent = '';
        var htmlStart =
                '<!DOCTYPE html>' +
                '<html>' +
