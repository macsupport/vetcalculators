  ...
  $('input.shock').each(function(index) {
   ...
   var lrs = (fluids * multiplier).toFixed(2);
    ...
    $('input.drug').each(function(index) {
      ...
      var appendVol =  $(this).attr('data-appendVol');
      if ($('#naloxDog').length) {
	   var naloxoneT = parseFloat(($('#naloxDog.label').html().replace(' ml', ''))*3).toFixed(2);
	   var lidoT = parseFloat(($('#lidoDog.label').html().replace(' ml', ''))*3).toFixed(2);
		var atroT = parseFloat(($('#atroDog.label').html().replace(' ml', ''))*3).toFixed(2);
		var epiT = parseFloat(($('#epiDogHi.label').html().replace(' ml', ''))*3).toFixed(2);
	 var vasoT = parseFloat(($('#vassopressinDog.label').html().replace(' ml', ''))*3).toFixed(2);
  }
...
if (!isNaN(kg)) {
    ...
    $(drugmg).text(parseFloat((kg * drug)).toFixed(2)).append(appendDose);
	  ...
	  $('#atroT.label').text(atroT).append(' ml');
	  $('#epiT.label').text(epiT).append(' ml');
	  $('#lidoT.label').text(lidoT).append(' ml');
	  $('#vasoT.label').text(vasoT).append(' ml');
	  $('#naloxoneT.label').text(naloxoneT).append(' ml');
